...
#include <memory>
#include "../FingerCoaster/Headers/scoreboard.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Scoreboard_t, stringdata0) + ofs), len 
...
const QMetaObject Scoreboard::staticMetaObject = { {
    ...
    qt_meta_stringdata_Scoreboard.offsetsAndSize,
