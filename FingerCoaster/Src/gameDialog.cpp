...
GameDialog::GameDialog(QWidget* parent)
  ...
  this->setStyleSheet(QString::fromUtf8(
      "#GameWindow {border-image: url(:/images/prefix1/board.jpeg) 0 0 0 0 "
      "stretch stretch;}"));
  ...
  ui->pb1->setStyleSheet(
      QString::fromUtf8("#QProgressBar1 {border: 2px solid grey;border-radius: "
                        "5px;background-color: #00FF00;}"));
  ui->pb2->setStyleSheet(
      QString::fromUtf8("#QProgressBar2 {border: 2px solid grey;border-radius: "
                        "5px;background-color: #00FF00;}"));
  ui->pb3->setStyleSheet(
      QString::fromUtf8("#QProgressBar3 {border: 2px solid grey;border-radius: "
                        "5px;background-color: #00FF00;}"));
  ui->pb4->setStyleSheet(
      QString::fromUtf8("#QProgressBar4 {border: 2px solid grey;border-radius: "
                        "5px;background-color: #00FF00;}"));

  ui->lineEdit->setObjectName(QString::fromStdString("lEdit"));
  ui->lineEdit->setStyleSheet(
      QString::fromUtf8("#lEdit {border: 2px solid grey;border-radius: 5px}"));
  ui->lwText->setStyleSheet(
      QString::fromUtf8("#lwText {border: 2px solid grey;border-radius: 5px}"));
  ...
  ui->lwText->setStyleSheet(QString::fromStdString(
...
void GameDialog::calculateWpm() {
  ...
  ui->wpm_label->setText(QString::fromStdString("Current WPM: ") +
                         QString::number(currentWpm));
}
